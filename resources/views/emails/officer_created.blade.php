...
@section('content')
    ...
    <div style="padding: 20px 0;">
        ...
        <p style="color: #334155; font-size: 16px;">Your account has been created for the Tourist Complaint Management System (TCMS).</p>
        ...
        <p style="color: #64748b; font-size: 14px;">Please login and change your password through system settings.</p>
